...
public class TSAClient {
	 ...
	 *
	 * @param data
	 *            the hashed data to get stamped
	 * @return the encoded time stamp token
	 * @throws IOException
	 *             if there was an error with the connection or data from the TSA
	 *             server, or if the time stamp response could not be validated
	 */
